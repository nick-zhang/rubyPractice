...
{
    /// <summary>
    /// Summary description for GcRegionOneColumnBuilderTest
    /// </summary>
    [TestClass]
    public class GcRegionOneColumnBuilderTest
    {
        public GcRegionOneColumnBuilderTest()
        {
            //
        ...
        {
            _sut = new GcRegionOneColumnBuilder(4);
        }
        //
        ...
        public void TestMethod1()
        {
            ...
            Assert.AreEqual(1, result.Rows[0].Cells.Count);
            Assert.AreEqual(4, result.Rows[0].Cells[0].Size.Width);


        }

        private GcRegionOneColumnBuilder _sut;

    }
}
/*+- OmniWorks Replacement History - hzproductsapi`GCFramework`GridGCUIBase`MsTest`GridGcUibaseMsTest:GcRegionOneColumnBuilderTest.cs;1 */
