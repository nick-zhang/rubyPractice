...
{
    internal class GcRangeTitleCellLeftBorderCalculator
    {
        public GcRangeTitleCellLeftBorderCalculator()
        {
        ...
        public GcBorder Calcuate(GcElementAnchor anchor)
        {
            ...
            if (anchor.Region == GcElementAnchorType.Left || anchor.Region == GcElementAnchorType.Full)
            {
                if(anchor.Cell == GcElementAnchorType.Left || anchor.Cell == GcElementAnchorType.Full)
                    border = BlockBorder;
                else
                {
...
/*+- OmniWorks Replacement History - hzproductsapi`GCFramework`GridGCUIBase`GCGridFramework:GcRangeTitleCellLeftBorderCalculator.cs;1 */
